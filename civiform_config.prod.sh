...
export CIVIFORM_VERSION="v2.18.0"
...
export SENDER_EMAIL_ADDRESS="civiform-notification@seattle.gov"
...
export BASE_URL="https://civiform.seattle.gov"
...
export ADFS_ADMIN_GROUP="f8c8e6c8-a5d7-4476-91bd-7f1691d16625"
...
export ESRI_WELLKNOWN_ID_OVERRIDE="2264"
